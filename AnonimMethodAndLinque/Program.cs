...
namespace AnonimMethodAndLinque
{
    class Program
        {
        class Debtor
        ...
        static void Main()
        {
            ...
            new Debtor("Shirley T. Qualls", DateTime.Parse("March 30, 1932"), "540-612-7938", "ShirleyTQualls@teleworm.us", "3565 Eagles Nest Drive Woodland, CA 95695", 2414),
            ...
            //var result1 = debtors.Where(d => d.Email.Contains("rhyta.com") || d.Email.Contains("dayrep.com")); 
            ...
            //2) Yashi 26 - dan 36 - ya qeder olan borclulari cixartm

            //var today =DateTime.Today;
            //var result2 = debtors.Where(d => today.Year - d.BirthDay.Year >= 26 && today.Year - d.BirthDay.Year <= 36);
            ...
            //var result3 = debtors.Where(d => d.Debt <= 5000);
            ...
            //var result4 = debtors.Where(d => d.FullName.Length >= 18 && d.Phone.Count(c => c == '7') >= 2);
            ...
            //var result5 = debtors.Where(d => d.BirthDay.Month == 12 || d.BirthDay.Month == 1 || d.BirthDay.Month == 2);
            ...
            //    .Select(d => new { Surname = d.FullName.Split(' ').Last(), Debt = d.Debt })
            //    .OrderBy(s => s.Surname)
            //    .ThenByDescending(d => d.Debt);
            //foreach (var d in result6)
            //{
            //    Console.WriteLine($"Surname : {d.Surname}, Debt : {d.Debt}");
            //}
            ...
            //    .Select(d => new { Surname = d.FullName.Split(' ').Last(), d.BirthDay, d.Debt });
            //foreach (var debtor in result7)
            //{
            //    Console.WriteLine($"Surname : [{debtor.Surname}] BirthDay : [{debtor.BirthDay.ToShortDateString()}] Debt : [{debtor.Debt}]");
            //}
            ...
            //var result9 = debtors
            //   .GroupBy(d => d.BirthDay)
            //   .OrderByDescending(g => g.Count())
            //   .FirstOrDefault();
            //if (result9 != null)
            //{
            //    Console.WriteLine($"En cox borclu dogulduqu il : {result9.Key}");
            //}
            //else
            //{
            //    Console.WriteLine("Butun tarixdeki borclular ferqli illerde dogulub");
            //}


            //10)Borcu en boyuk olan 5 borclunun siyahisini cixartmaq

            //var result10 = debtors
            ...
            //Console.WriteLine($"Total debt of all deptor : {totalDebt} AZN");


            //12)2ci dunya muharibesin gormush borclularin siyahisi cixartmaq

            //var result12 = debtors.Where(d => d.BirthDay.Year < 1946);
            ...
            //13)Nomresinde tekrar reqemler olmayan borclularin adlarini ve onlarin borcunun meblegin cixartmaq

            //var result13 = debtors
            //    .Where(d => d.Phone.Replace("-", "").Distinct().Count() == d.Phone.Replace("-", "").Length);

            //foreach (var d in result13)
            //{
            //    Console.WriteLine($"Name : {d.FullName}, Debt : {d.Debt}");
            //}
            ...
            //var today = DateTime.Today;
            //var result14 = debtors
            //    .Where(d => d.Debt > 0)
            //    .OrderBy(d => (d.BirthDay.Month < today.Month || (d.BirthDay.Month == today.Month && d.BirthDay.Day < today.Day)) ? d.BirthDay.AddYears(1) : d.BirthDay)
            //    .Select(d => d.FullName)
            //    .Distinct();

            //foreach (var debtorName in result14)
            //{
            //    Console.WriteLine($"Debtor : {debtorName}");
            //}


            //15)Adindaki ve familyasindaki herflerden "smile" sozunu yaza bileceyimiz borclularin siyahisini cixartmaq

            //var result15 = debtors
            //    .Where(d =>
            //    d.FullName.Contains("s") &&
            //    d.FullName.Contains("m") &&
            //    d.FullName.Contains("i") &&
            //    d.FullName.Contains("l") &&
            //    d.FullName.Contains("e"));
            //foreach (var d in result15)
            //{
            //    Console.WriteLine(d);
            //}
        }
